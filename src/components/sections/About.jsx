        ...
        <div className="space-y-6">
            <div className="border-b border-white/10 pb-4">
              ...
              <p className="font-onest text-base text-secondary/60 mt-1">
               ...
               <p className="font-onest text-base text-secondary/60 mt-1">
                 A three-year degree program with a primary focus on full-stack and web development. The curriculum integrated software development and architecture with graphic design, alongside core courses in DevOps, cybersecurity, and marketing.
              </p>
            </div>
             ...
             <div className="border-b border-white/10 pb-4">
              ...
              <p className="font-onest text-base text-secondary/60 mt-1">
                University-level course taken to strengthen analytical problem-solving and technical engineering skills.
              </p>
            </div>
            ...
            <div className="border-b border-white/10 pb-4">
              ...
              <p className="font-onest text-base text-secondary/60 mt-1">
               ...
               <p className="font-onest text-base text-secondary/60 mt-1">
                User-Centered Cybersecurity (10 ECTS), School of Engineering, Jönköping University (2025) Summer course in information security and user experience (UX), focusing on how to design secure systems.
              </p>
            </div>
