...
const MernNoteApp = () => {
  return (
    <div className="max-w-4xl mx-auto mt-26 my-8 shadow-xl rounded-2xl overflow-hidden">
      <div className="p-6 md:p-10 space-y-6">
        <div>
          <h2 className="text-3xl font-bold text-Yellow-800 mb-2">📝 MERN Note App</h2>
        ...
        <div className="pt-4">
          ...
          >
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 ml-4 px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition"
       >App</a>
