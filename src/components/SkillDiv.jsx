...
export const SkillDiv = () => {
  return (
    <div className="relative mx-auto z-10 w-full mt-10 md:w-3/4 lg:w-2/3 backdrop-blur-lg text-secondary rounded-lg shadow-xl overflow-hidden supports-[backdrop-filter]:bg-white/10 p-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <OneSkill name="Linux" level="Intermediate" />
