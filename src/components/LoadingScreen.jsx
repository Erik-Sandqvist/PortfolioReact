...
return (
  <div className="fixed inset-0 z-50 bg-#081A3A text-#D3B60A-100 flex flex-col items-center justify-center">
    ...
    <div className="mt-4 text-lg font-mono text-gray-300">
      Loading...
      </div>
  </div>
);
